...
return function(a, b) { return compare(a, b) * direction; };
    ...
    `
      ...
      math_single$$module$build$src$generators$javascript$math = function (a, b) {
          ...
          if ("NEG" === c)
              return (
                  (a = b.valueToCode(a, "NUM", Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION) || "0"),
                  "-" === a[0] && (a = " " + a),
                  ["-" + a, Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION]
              );
          a =
              "SIN" === c || "COS" === c || "TAN" === c
                  ? b.valueToCode(a, "NUM", Order$$module$build$src$generators$javascript$javascript_generator.DIVISION) || "0"
                  : b.valueToCode(a, "NUM", Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "0";
          switch (c) {
              case "ABS":
                  d = "Math.abs(" + a + ")";
                  break;
...
`
                    ...
                    ")")
              : "DIVISIBLE_BY" === d
              ? ((a = b.valueToCode(a, "DIVISOR", Order$$module$build$src$generators$javascript$javascript_generator.MODULUS) || "0"), (a = c + " % " + a + " === 0"))
              : (a = c + e);
          return [a, g];
      },
...
`
      ...
      text_print$$module$build$src$generators$javascript$text = function (a, b) {
          return "console.log(" + (b.valueToCode(a, "TEXT", Order$$module$build$src$generators$javascript$javascript_generator.NONE) || "''") + ");\n";
      },
...
`
      ...
      variables_set$$module$build$src$generators$javascript$variables = function (a, b) {
          ...
          return "var " + b.getVariableName(a.getFieldValue("VAR")) + " = " + c + ";\n";
      },
  ...
  var JavascriptGenerator$$module$build$src$generators$javascript$javascript_generator = class extends $.CodeGenerator$$module$build$src$core$generator {
          ...
          getAdjusted(a, b, c = 0, d = !1, e = Order$$module$build$src$generators$javascript$javascript_generator.NONE) {
              ...
              let g = e;
              0 < c
                  ? (g = Order$$module$build$src$generators$javascript$javascript_generator.ADDITION)
                  : 0 > c
                  ? (g = Order$$module$build$src$generators$javascript$javascript_generator.SUBTRACTION)
                  : d && (g = Order$$module$build$src$generators$javascript$javascript_generator.UNARY_NEGATION);
  ...
  var strRegExp$$module$build$src$generators$javascript$text = /^\s*'([^']|\\')*'\s*$/,
      forceString$$module$build$src$generators$javascript$text = function (a) {
          return strRegExp$$module$build$src$generators$javascript$text.test(a)
              ? [a, Order$$module$build$src$generators$javascript$javascript_generator.ATOMIC]
              : ["String(" + a + ")", Order$$module$build$src$generators$javascript$javascript_generator.FUNCTION_CALL];
      },
