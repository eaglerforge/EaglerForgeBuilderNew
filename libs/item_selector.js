...
function makeItemSelector(selected, useBlocks, triggerFn, options) {
    ...
    const fallbackBase64 = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABYAAAAWCAYAAADEtGw7AAAAAXNSR0IArs4c6QAAAEBJREFUSEtjNDc3/89AZRASEsLACDIYxKAmKCkpGTUYEqCjQQFPWKNBMRoUmKXMaKoYTRX0ThX///+nemUK8gMAG9lWY9CX1RAAAAAASUVORK5CYII="; // Example
    ...
    div.recalculateList = function () {
        ...
        list.forEach((item, idx) => {
            ...
            if (itemToRep(item) === selected) {
                ...
                div2.style.backgroundImage = `url(${getImageLocation(item.type === "block" ? getImageLocationBlock(item) : getImageLocationItem(item))}), url(${fallbackBase64})`, url(${highlightBase64});
