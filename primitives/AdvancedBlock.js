...
$$nmb_AdvancedBlock.prototype.$onEntityCollidedWithBlock = function(${argList}){ ${code}; return $$entityCollisionMethod(this, ${argList}); };`
        ...
        return (function AdvancedBlockDatablock(){
            ...
            function $$ServersideBlocks(){
                ...
                // === VERBATIM internal registration block ===
            ...
            ModAPI.addEventListener("lib:asyncsink", async () => {
                ...
                if(!$$blockModelJSON){
                    ...
                    // Model JSON uploaded
                    AsyncSink.setFile(`resourcepacks/AsyncSinkLib/assets/minecraft/models/block/${this.tags.id}.json`, await (await fetch($$blockModelJSON)).text());
                ...
                if(this.tags.animatedSpritesheetTexture){ animationCode; }
            });
        })();
    }
};
