...
PRIMITIVES["block_advanced"] = {
    ...
    asJavaScript: function () {
        ...
        var animationCode = AsyncSink.setFile(`resourcepacks/AsyncSinkLib/assets/minecraft/textures/blocks/${this.tags.id}.png.mcmeta`, efb2__str2ab(
            { "animation": { "frametime": Math.max(1, Math.round(this.tags.animatedTextureFrameDuration)) || 1, "interpolate": this.tags.animatedTextureInterpolate } }
        ));
        ...
        return (function AdvancedBlockDatablock() {
            ...
            ModAPI.addEventListener("lib:asyncsink", async () => {
                ...
                AsyncSink.setFile("resourcepacks/AsyncSinkLib/assets/minecraft/models/item/${this.tags.id}.json", JSON.stringify({
                    ...
                    "display": {
                        "thirdperson": { "rotation": [10, -45, 170], "translation": [0, 1.5, -2.75], "scale": [0.375,0.375,0.375] }
                    }
                }));
